...
execute if score @s inTimer matches ..0 store result score @s inItemCount run data get block ~ ~1 ~ Items[{Slot:1b}].Count
execute if score @s inTimer matches ..0 run scoreboard players remove @s inItemCount 1
execute if score @s inTimer matches ..0 store result block ~ ~1 ~ Items[{Slot:1b}].Count byte 1 run scoreboard players get @s inItemCount
